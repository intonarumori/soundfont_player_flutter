...
- (void)setTempo:(double)tempo
{
    if (drumSequencer != nullptr) {
        [(DrumSequencerAudioUnit*)drumSequencer.AUAudioUnit setTempo:tempo];
    }
    if (keyboardSequencer != nullptr) {
        [(SequencerAudioUnit*)keyboardSequencer.AUAudioUnit setTempo:tempo];
    }
}
...
{
    if (drumSequencer != nullptr) {
        return [(DrumSequencerAudioUnit*)drumSequencer.AUAudioUnit getTrack:sequence trackIndex:track];
    }
    return @{};
}
...
- (void)setKeyboardVolume:(double)volume
{
    if (keyboardSampler != nullptr) {
        keyboardSampler.volume = volume;
    }
}
