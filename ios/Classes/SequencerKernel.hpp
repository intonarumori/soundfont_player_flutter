...
public:
    SequencerKernel() {
        ...
        // initialize sequence
        sequence = {};
        addEvent({0.0, 0x90, 60, 100});
        addEvent({0.1, 0x80, 60, 0});
        addEvent({1.0, 0x90, 60, 100});
        addEvent({1.1, 0x80, 60, 0});
        addEvent({2.0, 0x90, 60, 100});
        addEvent({2.1, 0x80, 60, 0});
        addEvent({3.0, 0x90, 60, 100});
        addEvent({3.1, 0x80, 60, 0});
